        ...
        if feature in questions_dict and len(questions_dict[feature]) > 0:
            ...
            if feature == "GPA":
                ...
                user_input[feature] = st.selectbox(
                    ...
                    options=["Accounting", "Computer Science", "Medicine", "law", "Fine Arts", "Education", "Engineering", "Business Administration", "Psychology", "Biology", "Sociology", "Software Engineering", "Physics", "Nursing", "Civil Engineering", "Sports Science", "Journalism", "Architecture", "Chemistry"],
                    key=f"sel_{feature}"
                )
